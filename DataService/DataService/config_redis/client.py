...
class RedisClient:
    ...
    # def get_config(self, key, config_name='data_service'):
    #     configs = json.loads(self.client.get(config_name))
    ...
    def get_config(self, key, version='v1.1',config_name='data_service'):
